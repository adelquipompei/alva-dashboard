...
export default function AgregarProducto({ setLogueado }) {
  ...
  return (
    ...
    <>
      <BoxBienvenida
        icon={<AddCircleIcon sx={{ color: '#0288d1', fontSize: 28 }} />}
        text="Completa los datos del producto para agregarlo a tu lista y mantener tu inventario actualizado."
      ...
      <Box sx={{ display: "flex", justifyContent: "center", alignItems: "flex-start", minHeight: "100vh", p: 3 }}>
        ...
        <Paper elevation={5} sx={{ p: 4, borderRadius: 2, width: "100%", maxWidth: 700, mt: 4, background: 'linear-gradient(135deg, #fff8e1 0%, #ffe082 100%)', }}>
